...
st.subheader('Missing values of each column of dataset')
...
st.subheader('Column names of dataset containing numeric datatype ')
st.write(numeric_columns)

categorical_columns = df.select_dtypes(include=['object']).columns
categorical_df = df[categorical_columns]
st.subheader('Column names of dataset containing categorical datatype ')
