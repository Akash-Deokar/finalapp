...
st.title('All the best for the  most important step of EDA')
st.subheader("Don't have comma(,) separated dataset Convert your file into comma(,) separated format")
...
st.subheader('If you already have comma(,) separated dataset then upload your comma(,) separated file')
